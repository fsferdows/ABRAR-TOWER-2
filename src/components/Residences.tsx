...
export default function Residences() {
  const apartmentTypes: ApartmentType[] = [
    {
      ...
      verandas: 2,
      isCorner: true,
      idealFor: 'Symmetrical suites desiring fluid front-exposure daylight',
      description: 'Facing South-West (Front). Highlights an open-plan social spine designed with a fluid entry, living, and dining connection. Provides maximum daylight index and south-exposure cross vent drafts.',
      highlights: [
    ...
    },
    {
      ...
      verandas: 2,
      isCorner: true,
      idealFor: 'Families holding high value for front early sunrise aspects',
      description: 'Facing South-East (Front). A symmetrical master mirror to Unit A, designed with a spacious social core and large double glazed openings prioritizing morning daylight and cross-ventilation.',
      highlights: [
        'Master Bedroom (12\'-0" x 13\'-0") with attached bathroom',
        'Child Bedroom (11\'-0" x 12\'-0")',
    ...
    },
    {
      ...
      verandas: 1,
      isCorner: true,
      idealFor: 'Privacy-oriented dwellers wanting acoustic isolation',
      description: 'Facing North-West (Rear). Conceptualized with isolated private sleeping quarters for absolute quietude. Intentionally zones bedrooms away from lift lobbies and main corridor doors.',
      highlights: [
        'Master Bedroom (11\'-6" x 13\'-0") with attached bath',
        'Private detached master balcony for quiet vistas',
    ...
    },
    {
      ...
      verandas: 1,
      isCorner: true,
      idealFor: 'Professionals seeking serene northern skylights',
      description: 'Facing North-East (Rear). Symmetrical mirror of Unit C, delivering outstanding privacy and draft corridors. Keeps guest wings completely detached from main entertainment slots.',
      highlights: [
  ...
  const getVisibleRooms = (typeId: string) => {
    if (typeId === 'A' || typeId === 'B') {
      return [
        { id: 'master_bed', label: 'Master Bedroom', x: 15, y: 15, w: 125, h: 105, tag: '12\'-0" x 13\'-0"' },
        { id: 'master_bath', label: 'Attached Bath', x: 155, y: 15, w: 75, h: 50, tag: '8\'-0" x 5\'-0"' },
        { id: 'panoramic_verandah', label: 'South Verandah', x: 15, y: 130, w: 125, h: 30, tag: '4\'-0" x 11\'-0"' },
        { id: 'living_dining', label: 'Social Living/Dining', x: 245, y: 15, w: 180, h: 180, tag: '14\'-0" x 18\'-6"' },
        { id: 'linear_kitchen', label: 'Linear Kitchen', x: 245, y: 205, w: 85, h: 115, tag: '7\'-0" x 9\'-0"' },
        { id: 'child_bed', label: 'Child Bedroom', x: 15, y: 175, w: 125, h: 110, tag: '11\'-0" x 12\'-0"' },
        { id: 'common_bath', label: 'Common Bath', x: 155, y: 250, w: 75, h: 70, tag: '5\'-0" x 7\'-0"' },
        { id: 'utility_balcony', label: 'Utility Balcony', x: 345, y: 205, w: 80, h: 45, tag: '3\'-6" x 5\'-0"' }
      ];
    } else {
      return [
        { id: 'master_bed2', label: 'Master Bedroom', x: 15, y: 15, w: 125, h: 115, tag: '11\'-6" x 13\'-0"' },
        { id: 'master_bath2', label: 'Attached Bath', x: 155, y: 15, w: 75, h: 55, tag: '8\'-0" x 5\'-0"' },
        { id: 'private_balcony2', label: 'Master Balcony', x: 15, y: 140, w: 125, h: 25, tag: 'Private Space' },
        { id: 'guest_bed2', label: 'Guest Bedroom', x: 15, y: 175, w: 125, h: 110, tag: '11\'-0" x 11\'-0"' },
        { id: 'living_salon2', label: 'Living Salon', x: 245, y: 15, w: 180, h: 140, tag: '12\'-0" x 14\'-0"' },
        { id: 'dining_area2', label: 'Compact Dining', x: 245, y: 165, w: 100, h: 115, tag: '10\'-0" x 11\'-0"' },
        { id: 'chef_kitchen2', label: 'L-Chef Kitchen', x: 355, y: 165, w: 70, h: 115, tag: '6\'-6" x 9\'-0"' },
        { id: 'common_bath2', label: 'Common Bath', x: 155, y: 200, w: 75, h: 85, tag: '5\'-0" x 7\'-0"' }
      ];
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-20">
          <div className="p-6 rounded bg-neutral-950/40 border border-neutral-850 hover:border-gold-400/25 transition-all duration-300">
            <span className="font-mono text-gold-400 text-xs block mb-3 font-semibold">01 / LAYOUTS</span>
            <span className="font-serif text-md md:text-lg block mb-2 text-neutral-100">3 to 4 Bedrooms</span>
            <p className="text-xs text-neutral-500 leading-normal">Spacious configurations customizable to multi-generational requirements.</p>
          </div>
          <div className="p-6 rounded bg-neutral-950/40 border border-neutral-850 hover:border-gold-400/25 transition-all duration-300">
            <span className="font-mono text-gold-400 text-xs block mb-3 font-semibold">02 / KITCHENS</span>
            <span className="font-serif text-md md:text-lg block mb-2 text-neutral-100">Open-Concept Frame</span>
            <p className="text-xs text-neutral-500 leading-normal">Integrated with state-of-the-art ventilation points and high-pressure gas.</p>
          </div>
          <div className="p-6 rounded bg-neutral-950/40 border border-neutral-850 hover:border-gold-400/25 transition-all duration-300">
            <span className="font-mono text-gold-400 text-xs block mb-3 font-semibold">03 / BALCONIES</span>
            <span className="font-serif text-md md:text-lg block mb-2 text-neutral-100">Private Verandas</span>
            <p className="text-xs text-neutral-500 leading-normal">Large exterior verandas attached directly to master suites for visual retreat.</p>
          </div>
          <div className="p-6 rounded bg-neutral-950/40 border border-neutral-850 hover:border-gold-400/25 transition-all duration-300">
            <span className="font-mono text-gold-400 text-xs block mb-3 font-semibold">04 / GLASS WORK</span>
            <span className="font-serif text-md md:text-lg block mb-2 text-neutral-100">Performance Glazing</span>
            <p className="text-xs text-neutral-500 leading-normal">High-performance double panels to absorb solar radiation and block heat.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {apartmentTypes.map(apt => (
                  ...
                  >
                    Type {apt.id}
                    <span className="block text-[9px] opacity-80 font-sans mt-0.5">{apt.sizeSqFt} sq ft</span>
                  </button>
                ))}
              </div>
            ...
            <div className="mt-8 border-t border-neutral-850 pt-6 flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
              <div>
                <span className="text-xs text-neutral-500 font-sans block mb-1">Target Client Profile</span>
                <p className="text-xs text-gold-300 font-mono font-medium tracking-wide">
                  → Recommended for: {activeApartment.idealFor}
                </p>
              </div>
              <button
          ...
          <div className="lg:col-span-7 bg-neutral-950/70 border border-neutral-850 rounded-xl p-6 md:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs text-neutral-400 font-sans italic">
                  Hover rooms to examine dimension blueprints
                </span>
              </div>
            ...
            <div className="mt-6 p-4 rounded bg-neutral-900 border border-neutral-850 flex items-center justify-between min-h-[60px]">
              {hoveredRoom ? (
                <div>
                  <span className="font-mono text-[9px] text-gold-400 block uppercase tracking-wier">
                ...
                <div className="text-neutral-500 text-xs font-sans">
                  Hover over the architectural CAD blueprint above to examine structural sections.
                </div>
              )}
              {hoveredRoom && (
        ...
        {isCompareOpen && (
          ...
          >
            ...
            >
              ...
              <div className="mb-6">
                <span className="font-mono text-[9px] text-gold-400 uppercase tracking-widest block mb-1">UNIT EVALUATION MATRIX</span>
                <h3 className="font-serif text-2xl text-white font-normal">Side-by-Side Comparison</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 bg-neutral-950/40 p-4 rounded border border-neutral-850/60 w-full">
                <div>
                  <label className="block text-[9px] font-mono text-neutral-500 uppercase mb-1.5">UNIT REPRESENTATIVE I</label>
                  <select
                    value={compareUnitA}
                  ...
                  >
                    {apartmentTypes.map(apt => (
                      <option key={apt.id} value={apt.id} className="text-white bg-neutral-900">
                        {apt.name} ({apt.sizeSqFt} sq ft)
                      </option>
                    ))}
                  </select>
                </div>
                <div>
                  <label className="block text-[9px] font-mono text-neutral-500 uppercase mb-1.5">UNIT REPRESENTATIVE II</label>
                  <select
                    value={compareUnitB}
              ...
              {(() => {
                ...
                const getFacing = (id: string) => {
                  if (id === 'A') return 'SOUTH-WEST (Front, Solar Max)';
                  if (id === 'B') return 'SOUTH-EAST (Front, Morning Light)';
                  if (id === 'C') return 'NORTH-WEST (Rear, Thermal Calm)';
                  return 'NORTH-EAST (Rear, Serene Sky)';
                };

                const getPrice = (id: string) => {
                  if (id === 'A' || id === 'B') return '~ 1.38 Crore BDT';
                    ...
                    <table className="w-full text-left font-sans text-xs border-collapse text-neutral-300 min-w-[600px]">
                      <thead>
                        <tr className="bg-neutral-950/80 border-b border-neutral-800 font-mono text-[10px] text-neutral-400">
                          <th className="p-3 w-[250px]">SPECIFICATION MATRIX</th>
                      ...
                      <tbody className="divide-y divide-neutral-850">
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">NET FLOOR PLOT SIZE</td>
                          <td className="p-3 font-semibold text-white bg-gold-400/5">{u1.sizeSqFt} SQ FT</td>
                          <td className="p-3 font-semibold text-white">{u2.sizeSqFt} SQ FT</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">BEDROOMS CONFIG</td>
                          <td className="p-3 bg-gold-400/5">{u1.bedrooms} Bed Tiers</td>
                          <td className="p-3">{u2.bedrooms} Bed Tiers</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">BATHROOMS LOBBY</td>
                          <td className="p-3 bg-gold-400/5">{u1.bathrooms} Luxe Baths</td>
                          <td className="p-3">{u2.bathrooms} Luxe Baths</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">VERANDAS & BALCONIES</td>
                          <td className="p-3 bg-gold-400/5">{u1.verandas} Attached Bays</td>
                          <td className="p-3">{u2.verandas} Attached Bays</td>
                        </tr>
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">ORIENTATION & WINDFLOW</td>
                        ...
                        <tr>
                          <td className="p-3 font-mono text-neutral-500">CORNER STATUS</td>
                          <td className="p-3 text-emerald-400 font-semibold bg-gold-400/5">100% Corner Secured</td>
                          <td className="p-3 text-emerald-400 font-semibold">100% Corner Secured</td>
                        </tr>
                        <tr>
