...
export default function BuilderConsole() {
  ...
  const [activeTab, setActiveTab] = useState<'jv-calc' | 'specs' | 'cad-packages' | 'feasibility' | 'cost-estimate' | 'visual-specs'>('jv-calc');
  ...
  useEffect(() => {
    ...
    // Mean unit size modeled inside Abrar Tower is ~ 900 sq ft (average of front units A/B and rear units C/D)
    ...
    <section id="builder" className="py-24 md:py-32 bg-neutral-950 text-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex border-b border-neutral-850 gap-1 mb-10 overflow-x-auto pb-px scrollbar-thin">
          ...
          <button
            onClick={() => setActiveTab('visual-specs')}
            className={`py-4 px-5 font-mono text-[10.5px] uppercase tracking-wider border-b flex-shrink-0 flex items-center gap-1.5 cursor-pointer transition-all duration-300 ${
          ...
          >
            <Eye size={12} stopColor="#d4af37" />
            <span>{language === 'bn' ? 'স্থাপত্য দৃষ্টিভঙ্গি' : '3D Design Specs'}</span>
          </button>
          ...
          <AnimatePresence mode="wait">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-neutral-850 pt-6">
                      <div className="bg-neutral-900/60 p-4 rounded border border-neutral-850 flex flex-col justify-between">
                        ...
                        <div className="border-t border-neutral-850 mt-4 pt-2 flex justify-between font-mono text-[10px] text-neutral-500">
                          ...
                          <span className="text-white font-bold">{ownerSqFt.toLocaleString(undefined, {maxFractionDigits: 0})} {language === 'bn' ? 'বর্গফুট' : 'SQFT'}</span>
                        </div>
                      </div>
                      ...
                      <div className="bg-neutral-900/60 p-4 rounded border border-neutral-850 flex flex-col justify-between">
                        ...
                        <div className="border-t border-neutral-850 mt-4 pt-2 flex justify-between font-mono text-[10px] text-neutral-500">
                          <span>{language === 'bn' ? 'মোট হিঃ আয়তন:' : 'SHARE AREA:'}</span>
                          <span className="text-white font-bold">{devSqFt.toLocaleString(undefined, {maxFractionDigits: 0})} {language === 'bn' ? 'বর্গফুট' : 'SQFT'}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="lg:col-span-4 border-r border-neutral-850 pr-6 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 text-gold-300 font-mono text-[9px] uppercase tracking-wider mb-2">
                      ...
                      <span>{language === 'bn' ? 'আব্রার টাওয়ার-২ প্রাক-ডিজাইন বিশ্লেষণ' : 'ABRAR TOWER-2 PRE-DESIGN SURVEY'}</span>
                    </div>
                    ...
                    <p className="text-neutral-400 text-xs font-sans leading-relaxed mb-6 font-light">
                      {language === 'bn' 
                        ? 'উত্তরা সেক্টর ১৩-এর ১০ কাঠা প্লটের ওপর প্রস্তাবিত আবরার টাওয়ার-২ প্রকল্পের জন্য প্রস্তুতকৃত একটি বিস্তারিত বিনিয়োগ সম্ভাব্যতা সমীক্ষা।'
                        : 'A rigorous pre-construction feasibility dossier analyzing municipal codes, micro-economic valuations, and ROI schedules for Abrar Tower-2 in Uttara.'}
                    </p>
                ...
                <div className="lg:col-span-8 bg-neutral-900/60 rounded-xl border border-neutral-850 p-6 md:p-8 overflow-y-auto max-h-[580px] scrollbar-thin">
                  <div className="border-b border-neutral-850 pb-6 mb-8 text-center">
                    ...
                    <h4 className="font-serif text-2xl font-light text-white tracking-wide">
                      {language === 'bn' ? 'প্রকল্প সম্ভাব্যতা যাচাই সমীক্ষা: আবরার টাওয়ার-২' : 'Project Feasibility Study: Abrar Tower-2'}
                    </h4>
                    <span className="font-mono text-[9px] text-[#666] block mt-1 uppercase">Uttara Dhaka // G+9 Storeys // 36 Luxury Suites // 10 Katha</span>
                  </div>
                  ...
                  <div className="space-y-8 font-sans text-xs text-neutral-300 font-light leading-relaxed">
                    ...
                    <div className="p-4 bg-neutral-950/30 rounded border border-neutral-850 hover:border-gold-400/20 transition-all">
                      ...
                      <p className="pl-3 border-l border-neutral-800">
                        {language === 'bn'
                          ? 'আবরার টাওয়ার-২ ঢাকা শহরের উত্তরার অভিজাত আবাসিক এলাকায় একটি আধুনিক, নান্দনিক ট্রিপল-এক্স ল্যান্ডমার্ক প্রতিষ্ঠার লক্ষ্যে গৃহীত হয়েছে। এটি কেবলমাত্র একটি বাসভবনই নয়, বরং পরিবেশ বান্ধব টেকসই স্থাপত্য এবং আধুনিক স্ট্রাকচারাল রিইনফোর্সমেন্টের সংমিশ্রণে তৈরি এক মাস্টারপিস।'
                          : 'Abrar Tower-2 represents a signature luxury residential initiative sated in Uttara, Dhaka. Designed as an landmark building footprint, this project is geared for high-net-worth individuals and returning NRB buyers seeking privacy, maximum daylight, and unparalleled core engineering standards.'}
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-neutral-950/30 rounded border border-neutral-850 hover:border-gold-400/20 transition-all">
                      ...
                      <div className="pl-3 border-l border-neutral-800 space-y-2">
                        <p>
                          {language === 'bn'
                            ? 'প্রকল্পটি একটি ১০-তলা বিশিষ্ট প্রিমিয়াম রেসিডেনশিয়াল টাওয়ার। এতে থাকছে মোট ৩৬টি কর্নার ফ্ল্যাট (প্রতিটি তলায় ৪টি করে অনন্য কোণায় অবস্থিত ফ্ল্যাট)। নিচতলায় গাড়ি পার্কিংয়ের পরিবর্তে থাকছে আকর্ষণীয় ইনডোর ল্যান্ডস্কেপিং এবং ডাবল-হিট লাক্সারি রিসেপশন লবি।'
                            : 'The project comprises a G+9 premium residential tower spanning exactly 36 exclusive corner apartments (featuring exactly 4 corner units per floor to ensure three-way natural ventilation). Sited on a 10-Katha plot, the structure completely eliminates surface-level asphalt in favor of a landscaped internal sanctuary.'}
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 font-mono text-[9px] text-[#aaa] mt-3">
                          <div className="p-2 bg-neutral-950 rounded">
                            <span className="text-[8px] text-neutral-500 block">STOREYS</span>
                            <span className="text-white font-bold block">10 (G+9 Floors)</span>
                          </div>
                          <div className="p-2 bg-neutral-950 rounded">
                            <span className="text-[8px] text-neutral-500 block">TOTAL FLATS</span>
                            <span className="text-white font-bold block">36 Premium Suites</span>
                          </div>
                          <div className="p-2 bg-neutral-950 rounded">
                            <span className="text-[8px] text-neutral-500 block">FLATS PER FLOOR</span>
                            <span className="text-white font-bold block">4 Corner Units</span>
                          </div>
                          <div className="p-2 bg-neutral-950 rounded">
                    ...
                    <div className="p-4 bg-neutral-950/30 rounded border border-neutral-850 hover:border-gold-400/20 transition-all">
                      ...
                      <p className="pl-3 border-l border-neutral-800">
                        {language === 'bn'
                          ? 'বাজারে বিদ্যমান অধিকাংশ ভবনেই অন্ধকার ও অপ্রশস্ত রুমের জটিলতা থাকে। আবরার টাওয়ার-২-এর অনন্য ৪-কর্নার নকশা নিশ্চিত করে যে কোনো ফ্ল্যাটেই কোলাহলপূর্ণ বা অন্ধকার ঘরের সমস্যা থাকবে না। প্রকল্পটি অভিজাত প্রবাসী বাংলাদেশী (NRB), স্বনামধন্য চিকিৎসক এবং উচ্চ পদস্থ কর্মকর্তাদের টার্গেট করে প্রিমিয়াম আন্ডারটোন দিয়ে বাজারে পজিশন করা হয়েছে।'
                          : 'Standard multi-family layouts in Dhaka typically suffer from generic dark core rooms. Abrar Tower-2 resolves this structural defect by deploying a strict 100% Corner Residence template with three-way exterior exposure. Positioning targets long-term corporate executives, returning NRBs, and professional practitioners seeking quiet elegance and top-tier security profiles.'}
                      </p>
                    </div>
              ...
              >
                ...
                <div className="lg:col-span-4 border-r border-neutral-850 pr-6 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-neutral-400 text-xs font-sans leading-relaxed mb-6 font-light">
                      {language === 'bn' 
                        ? 'আব্রার টাওয়ার-২ এর জন্য রাজউক ও বিএন্ডবি স্ট্যান্ডার্ড ও প্রিমিয়াম উপাদান ভিত্তিক খরচ অনুমান সিমুলেটর।'
                        : 'Adjust finishes and design reserves to scale dynamic structural budgets for the Abrar Tower-2 development.'}
                    </p>
            ...
            {activeTab === 'visual-specs' && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -12 }}
                transition={{ duration: 0.3 }}
                className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch animate-fade"
              >
                {/* Visual specs left specs descriptors */}
                <div className="lg:col-span-5 flex flex-col justify-between gap-6 pr-2">
                  <div>
                    <div className="flex items-center gap-2 text-gold-300 font-mono text-[9px] uppercase tracking-wider mb-2">
                      <Sparkles size={11} className="text-gold-400 animate-pulse" />
                      <span>{language === 'bn' ? 'উন্নত ত্রিমাত্রিক রেন্ডার প্যারামিটার' : 'PHYSICALLY IN-SITU GRAPHIC SPECS'}</span>
                    </div>
                    <h3 className="font-serif text-xl font-normal text-white mb-2 leading-tight">
                      {language === 'bn' ? 'সিনেম্যাটিক ৩ডি স্থপতি ভিউ' : 'Premium 3D Architectural Renditions'}
                    </h3>
                    <p className="text-neutral-400 text-xs font-sans leading-relaxed mb-6 font-light">
                      {language === 'bn'
                        ? 'আব্রার টাওয়ার-২ এর ত্রিমাত্রিক দৃশ্যে নিখুঁত বৈশ্বিক আলোকায়ন বা গ্লোবাল ইলুমিনেশন এবং শারীরিকভাবে বাস্তব কোড রয়েছে।'
                        : 'Review photorealistic pre-constructions credentials for the Abrar Tower-2 development envelope. High-performance material indexes built with precise global sunset lighting.'}
                    </p>

                    <div className="space-y-4">
                      {/* Glass specifications */}
                      <div className="p-3 bg-neutral-950/80 rounded border border-neutral-850 flex gap-3.5 hover:border-gold-400/25 transition-all">
                        <div className="w-8 h-8 rounded-full bg-gold-400/10 flex items-center justify-center text-gold-400 text-xs font-mono flex-shrink-0">
                          01
                        </div>
                        <div>
                          <span className="text-xs font-mono font-bold text-white block uppercase mb-1">Double-Glazed Low-E Glass Facade</span>
                          <span className="text-neutral-400 text-[11px] font-sans leading-normal block">
                            High-durability vacuum chamber double-pane glazing completely deflects heat waves while inviting golden natural daylights.
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-neutral-950/80 rounded border border-neutral-850 flex gap-3.5 hover:border-gold-400/25 transition-all">
                        ...
                        <div>
                          <span className="text-xs font-mono font-bold text-white block uppercase mb-1">Frameless Structural Glass Balconies</span>
                          <span className="text-neutral-400 text-[11px] font-sans leading-normal block">
                            Frameless, ultra-clear tempered laminated security safety sheets ensure seamless delta views with zero visual noise.
                          </span>
                        </div>
                      </div>

                      {/* Landscaped Lobby specs */}
                      <div className="p-3 bg-neutral-950/80 rounded border border-neutral-850 flex gap-3.5 hover:border-gold-400/25 transition-all">
                        <div className="w-8 h-8 rounded-full bg-gold-400/10 flex items-center justify-center text-gold-400 text-xs font-mono flex-shrink-0">
                          03
                        </div>
                        <div>
                          <span className="text-xs font-mono font-bold text-white block uppercase mb-1">Grand Zen Reception Void (Zero Parking)</span>
                          <span className="text-neutral-400 text-[11px] font-sans leading-normal block">
                            By moving all parking underground, the ground envelope introduces customized indoor flora, quiet bubbling ponds, and double-height custom concrete salons.
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-neutral-950/60 rounded border border-neutral-850 flex gap-3 text-2xs text-neutral-400 leading-normal font-sans">
                    <Info size={16} className="text-gold-400 flex-shrink-0" />
                    <span>
                      {language === 'bn'
                        ? 'আমাদের ৩ডি ভিজ্যুয়ালাইজেশনগুলি নিখুঁত সূর্য কোণ এবং ঢাকার অক্ষাংশের গোলার্ধের সাথে মিলিয়ে আলো পরীক্ষা করে গ্যারান্টি দেয়।'
                        : 'Rendering cycles perform physically accurate ray-tracer analysis. Structural models align with real longitude/latitude parameters of Uttara.'}
                    </span>
                  </div>
                </div>

                {/* Visual specs right 3D blueprint representation render */}
                <div className="lg:col-span-7 bg-neutral-950 border border-neutral-850 rounded-xl p-6 md:p-8 flex flex-col justify-between relative overflow-hidden min-h-[460px]">
                  {/* Neon atmospheric glow */}
                  <div className="absolute right-[-10%] top-[-10%] w-72 h-72 bg-gold-400/15 rounded-full blur-[100px]" />
                  
                  <div>
                    <span className="font-mono text-[9px] tracking-widest text-[#999] uppercase block mb-1">3D RENDER SCHEMATICS GRID</span>
                    <h4 className="font-serif text-xl font-normal text-white mb-6">Abrar Tower-2 Sunset Silhouette Elevation</h4>

                    {/* Mock Premium Golden Blueprint/Render Container */}
                    <div className="w-full h-76 bg-neutral-900 rounded-lg border border-neutral-800 relative flex items-center justify-center overflow-hidden">
                      {/* Geometric grid mesh pattern */}
                      <div className="absolute inset-0 bg-[linear-gradient(rgba(212,175,55,0.015)_1px,transparent_1px),linear-gradient(90deg,rgba(212,175,55,0.015)_1px,transparent_1px)] bg-[size:16px_16px]" />
                      
                      {/* CSS Abstract Architectural Silhouette */}
                      <div className="relative w-48 h-64 border-x border-[#333] flex flex-col justify-end p-2 bg-gradient-to-t from-neutral-950 to-neutral-900/30">
                        {/* Core framing line */}
                        <div className="absolute inset-y-0 left-12 w-[1px] bg-gold-400/10 pointer-events-none" />
                        <div className="absolute inset-y-0 right-12 w-[1px] bg-gold-400/10 pointer-events-none" />
                        
                        {/* Rooftop garden terrace visual representation */}
                        <div className="absolute top-1 left-2 right-2 h-7 border-t border-b border-gold-400/30 bg-neutral-950/80 rounded-t flex flex-col justify-center px-2">
                          <span className="text-[7px] font-mono text-gold-400 uppercase tracking-widest leading-none block">TERRACE GARDEN</span>
                          <span className="text-[6px] text-neutral-500 font-sans block leading-none mt-1">Solar Grid & Pergola Core</span>
                          {/* Solar grid icons simulated */}
                          <div className="flex gap-1 mt-1">
                            <span className="w-2.5 h-1 bg-amber-500/20 rounded" />
                            <span className="w-2.5 h-1 bg-amber-500/20 rounded" />
                            <span className="w-2.5 h-1 bg-amber-500/20 rounded" />
                          </div>
                        </div>
                        ...
                        {/* Stories lines core */}
                        <div className="space-y-1.5 w-full mt-8 z-10">
                          {Array.from({ length: 9 }).map((_, i) => (
                            <div key={i} className="h-4 border border-neutral-800 rounded bg-neutral-950/90 flex justify-between items-center px-1.5 hover:border-gold-400/35 transition-all">
                              <span className="text-[6px] font-mono text-[#555]">L{9 - i} COORD</span>
                              <div className="flex gap-1">
                                <span className="w-5 h-1 bg-neutral-900 rounded" />
                                <span className="w-5 h-1 bg-neutral-900 rounded" />
                                <span className="w-5 h-1 bg-neutral-900 rounded" />
                                <span className="w-5 h-1 bg-neutral-900 rounded" />
                              </div>
                        ...
                        {/* Double height Grand lobby void */}
                        <div className="h-10 mt-1.5 border border-dashed border-gold-400/30 rounded bg-neutral-950 flex flex-col justify-center px-2">
                          <span className="text-[7.5px] font-mono text-gold-300 font-bold uppercase tracking-wider block">GRAND RECEPTION VOID</span>
                          <span className="text-[6px] text-neutral-500 block leading-normal">Biodiverse Indoor Landscaping // No Surface Parking Floor</span>
                        </div>
                      </div>

                      {/* Camera Overlay Metrics */}
                      <div className="absolute top-4 left-4 font-mono text-[7.5px] text-[#555] space-y-0.5">
                        <span className="block">FOCAL DEPTH: 110mm F/3.5</span>
                        <span className="block">ILLUMINATION: SUNSET DELTA GRID</span>
                      </div>
                      
                      <div className="absolute bottom-4 right-4 font-mono text-[8px] text-gold-400 animate-pulse bg-neutral-950/80 px-2 py-0.5 border border-neutral-800 rounded">
                        <span>• OPTIMIZED FOR DAYLIGHT REGIME</span>
                      </div>
                    </div>
                  </div>

                  {/* Rooftop Garden detailed list */}
                  <div className="mt-6 pt-6 border-t border-neutral-850 grid grid-cols-2 gap-4 text-xs">
                    <div>
                      <span className="font-mono text-[8px] text-neutral-500 block uppercase mb-1">ROOFTOP TERRACE ENVELOPE</span>
                      <p className="text-neutral-400 font-light leading-normal">
                        Features a hand-crafted heavy timber pergola, seating lounges, water-walls, and an embedded 25KW solar grid powering common elevators.
                      </p>
                    </div>
                    <div>
                      <span className="font-mono text-[8px] text-neutral-500 block uppercase mb-1">DAYLIGHT GROUND PENETRATION</span>
                      <p className="text-neutral-400 font-light leading-normal">
                        By completely removing surface-level parking and employing raw-engineered structural concrete columns, direct daylight infiltrates the central reception cores.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div>
                    ...
                    <p className="text-neutral-400 text-xs font-sans mt-1">
                      {language === 'bn' 
                        ? 'রাজউকের সাধারণ নিয়মরক্ষার বিপরীতে আবরার-২ এর চমৎকার নির্মাণ গুণমান পরীক্ষা।'
                        : "Comparing municipal minimum benchmarks to Abrar's signature build levels."}
                    </p>
                  </div>
                  ...
                  <table className="w-full text-left font-sans text-xs border-collapse min-w-[700px]">
                    <thead>
                      <tr className="bg-neutral-950/80 border-b border-neutral-800 font-mono text-[10px] text-neutral-400">
                        ...
                        <th className="p-4 text-gold-300 bg-gold-400/5">{language === 'bn' ? 'আবরার টাওয়ার-২ এর অনন্য মানদণ্ড' : 'ABRAR TOWER-2 EXCELLENCE TIER'}</th>
